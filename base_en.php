...
<head>
  ...
  <title>TheRichAunty - Sissy Aïsha</title>
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.html">TheRichAunty</a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          <h1>Welcome to <span>TheRichAunty</span></h1>
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>TheRichAunty is a self-employed business created and run by Sissy Aïsha.</h3>
            <p class="fst-italic">
              At TheRichAunty we offer many African meals in the shortest time possible while ensuring that customer satisfaction is a priority. Its motto is :
            </p>
            <ul>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="menu-flters">
              ...
              <li data-filter=".filter-starters">Lunch</li>
              <li data-filter=".filter-salads">Salads</li>
              <li data-filter=".filter-specialty">African Foods</li>
            </ul>
          </div>
        </div>
    ...
    <section id="events" class="events">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Events</h2>
          <p>Various events to which we have been asked</p>
        </div>
    ...
    <section id="book-a-table" class="book-a-table">
      <div class="container" data-aos="fade-up">
        ...
        <form action="index.php?lang=en&control=book_a_table" method="POST" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
          <div class="row">
          ...
          <input type="hidden" name="control" value="book_a_table">
          <div class="text-center"><button type="submit" name="send">Book a Table</button></div>
        </form>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-1">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="index.php?lang=en&control=contact_us" method="post" role="form" class="php-email-form">
              <div class="row">
  ...
  <footer id="footer">
          ...
          <div class="col-lg-5 col-md-6">
            <div class="footer-info">
              ...
              <p>
                ...
                <strong>Phone:</strong> +1 438 921 9499<br>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>TheRichAunty</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
